...
public class ScreenerResponse{
	...
	public List<String> getIndustyGroups() {
		return industyGroups;
	}
	public void setIndustyGroups(List<String> industyGroups) {
		this.industyGroups = industyGroups;
	}
	public void setIndustries(List<String> industries) {
		this.industries = industries;
	}
	private List<String> industries;
	private List<String> industyGroups;
