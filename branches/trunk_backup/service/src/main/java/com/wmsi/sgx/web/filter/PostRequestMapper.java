 ...
 *
 */
public class PostRequestMapper extends HttpServletRequestWrapper{
	 ...
	 */
	public PostRequestMapper(HttpServletRequest request, String param){
		super(request);	
		this.param = param;
	}
	 ...
	 */
	public PostRequestMapper(HttpServletRequest request, String param, String contentType){
		this(request, param);
