...
//	console.log(request);
	if(request[0]===0){
		...
		case 'pageRenderBase64':
			...
			break;
		case 'pageSet':
			if (request[4].hasOwnProperty("header") && request[4].header.hasOwnProperty("contents")) {
	            eval('request[4].header.contents = phantom.callback('+request[4].header.contents+')');
			}
			if (request[4].hasOwnProperty("footer") && request[4].footer.hasOwnProperty("contents")) {
